...
@property (nonatomic, readonly, strong) PESDKColorToolControllerOptions * _Nonnull textColorToolControllerOptions;
...
/// Options for the <code>TextColorToolController</code>.
- (void)configureTextColorToolController:(SWIFT_NOESCAPE void (^ _Nonnull)(PESDKColorToolControllerOptionsBuilder * _Nonnull))builder;
/// Options for the <code>AdjustToolController</code>.
...
@property (nonatomic, strong) CIImage * _Nullable image;
...
- (UIScrollView * _Nullable)overlayEditControllerProxyScrollView:(PESDKOverlayEditController * _Nonnull)overlayEditController SWIFT_WARN_UNUSED_RESULT;
...
- (PESDKPaintingFragment * _Nonnull)inverseFor:(PESDKPainting * _Nonnull)painting SWIFT_WARN_UNUSED_RESULT;
