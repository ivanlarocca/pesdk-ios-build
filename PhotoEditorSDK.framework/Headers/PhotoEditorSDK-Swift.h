...
/// \param textBuilder A <code>BrushColorToolControllerOptionsBuilder</code> object.
///
...
@property (nonatomic, readonly) BOOL isPhoneWithLargeHeight SWIFT_DEPRECATED_OBJC("Swift property 'UIDevice.isPhoneWithLargeHeight' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
